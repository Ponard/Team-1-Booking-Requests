...
npm run dev
```
The server will start on `https://cngqa-180-190-226-223.run.pinggy-free.link` (or the port specified in your .env file)
...
- Development: `https://cngqa-180-190-226-223.run.pinggy-free.link` (for Android emulator)
...
2. Verify the backend is running by accessing: `https://cngqa-180-190-226-223.run.pinggy-free.link/health`
3. Then start the Flutter app: `flutter run`

### Important Configuration Notes:

#### For Android Emulator:
- The default API URL in the Flutter app is configured for Android emulator (`https://cngqa-180-190-226-223.run.pinggy-free.link`)
