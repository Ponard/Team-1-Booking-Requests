...
Base URL: `http://cngqa-180-190-226-223.run.pinggy-free.link/api` (dev)  
Swagger UI: `http://cngqa-180-190-226-223.run.pinggy-free.link/api-docs`
...
PORT=3000
API_URL=http://cngqa-180-190-226-223.run.pinggy-free.link
...
# CORS
ALLOWED_ORIGINS=http://cngqa-180-190-226-223.run.pinggy-free.link,http://localhost:8080
...
# 5. Start dev server
npm run dev    # http://cngqa-180-190-226-223.run.pinggy-free.link
```
