...
async function runMigrations() {
  ...
  try {
    ...
    console.log('   - Access the API at https://cngqa-180-190-226-223.run.pinggy-free.link');
    console.log('   - Access Swagger docs at https://cngqa-180-190-226-223.run.pinggy-free.link/api-docs');
