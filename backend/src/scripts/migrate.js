...
async function runMigrations() {
  ...
  try {
    ...
    console.log('   - Access the API at http://cngqa-180-190-226-223.run.pinggy-free.link');
    console.log('   - Access Swagger docs at http://cngqa-180-190-226-223.run.pinggy-free.link/api-docs');
